...
if(NOT DEFINED CROSS_COMPILE)
    ...
    set(COMPILER_FILE "${SBSA_DIR}/tools/cmake/toolchain/gnuarm.cmake")
endif ()
...
if(DEFINED CC)
    ...
    if (CC MATCHES "^.*armclang(\\.exe)?$")
        ...
        set(COMPILER_FILE "${SBSA_DIR}/tools/cmake/toolchain/armclang.cmake")
    elseif (CC MATCHES "^.*clang(\\.exe)?$")
        set(CMAKE_C_COMPILER_ID "CLANG" CACHE INTERNAL "C compiler ID" FORCE)
        set(COMPILER_FILE "${SBSA_DIR}/tools/cmake/toolchain/clang.cmake")
    else()
...
set(LINKER_FILE "${SBSA_DIR}/tools/cmake/toolchain/linker.cmake")
