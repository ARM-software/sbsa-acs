...
#define TEST_NUM   (AVS_PCIE_TEST_NUM_BASE + 27)
...
payload(void)
{
  ...
  table_entries = sizeof(bf_info_table27)/sizeof(bf_info_table27[0]);
  ret = val_pcie_register_bitfields_check((void *)&bf_info_table27, table_entries);
