...
#define TEST_NUM   (AVS_PCIE_TEST_NUM_BASE + 28)
...
payload(void)
{
  ...
  table_entries = sizeof(bf_info_table28)/sizeof(bf_info_table28[0]);
  ret = val_pcie_register_bitfields_check((void *)&bf_info_table28, table_entries);
