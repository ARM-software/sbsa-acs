...
#define TEST_NUM   (AVS_PCIE_TEST_NUM_BASE + 23)
...
payload(void)
{
  ...
  table_entries = sizeof(bf_info_table23)/sizeof(bf_info_table23[0]);
  ret = val_pcie_register_bitfields_check((void *)&bf_info_table23, table_entries);
