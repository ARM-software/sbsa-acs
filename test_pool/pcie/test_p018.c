...
#define TEST_NUM   (AVS_PCIE_TEST_NUM_BASE + 18)
#define TEST_DESC  "All switches must implement minimal ACS features if P2P supported"
...
static void payload(void)
{
    ...
    while (count > 0) {
        ...
        if (pcie_type == PCIE_TYPE_DOWNSTREAM) {
            /* check if switch supports peer to peer */
