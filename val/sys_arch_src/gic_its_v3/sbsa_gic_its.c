...
static uint32_t        g_its_setup_done = 0;
  ...
  )
{
  ...
  uint32_t     GicRedistributorGranularity;
  ...
  if (length == 0)
  {
      Affinity = val_mmio_read(GicCpuRedistributorBase + ARM_GICR_TYPER + NEXT_DW_OFFSET);
...
{
  return (val_mmio_read(GicDistributorBase + ARM_GICD_TYPER) & ARM_GICD_TYPER_LPIS);
}
...
{
  return (val_mmio_read(GicRedistributorBase + ARM_GICR_TYPER) & ARM_GICR_TYPER_PLPIS);
}
  ...
  )
{
  ...
  if (!Address) {
    val_print(AVS_PRINT_ERR,  "ITS : Could Not Allocate Memory For Command Q. Test may not pass.\n", 0);
    return 1;
  }
  ...
  )
{
  ...
  if (!Address) {
      val_print(AVS_PRINT_ERR,  "ITS : Could Not Allocate Memory For DT/CT. Test may not pass.\n", 0);
      return 1;
  }
...
{
    val_mmio_write64((uint64_t)(CMDQ_BASE + g_cwriter_ptr[ItsIndex]), (uint64_t)((DevID << ITS_CMD_SHIFT_DEVID) | ARM_ITS_CMD_MAPD));
    val_mmio_write64((uint64_t)(CMDQ_BASE + g_cwriter_ptr[ItsIndex] + 1), (uint64_t)(Size));
    val_mmio_write64((uint64_t)(CMDQ_BASE + g_cwriter_ptr[ItsIndex] + 2), (uint64_t)((Valid << ITS_CMD_SHIFT_VALID) | (ITT_BASE & ITT_PAR_MASK)));
    val_mmio_write64((uint64_t)(CMDQ_BASE + g_cwriter_ptr[ItsIndex] + 3), (uint64_t)(0x0));
...
{
    val_mmio_write64((uint64_t)(CMDQ_BASE + g_cwriter_ptr[ItsIndex] ), (uint64_t)(ARM_ITS_CMD_MAPC));
    val_mmio_write64((uint64_t)(CMDQ_BASE + g_cwriter_ptr[ItsIndex] + 1), (uint64_t)(0x0));
    val_mmio_write64((uint64_t)(CMDQ_BASE + g_cwriter_ptr[ItsIndex] + 2), (uint64_t)((Valid << ITS_CMD_SHIFT_VALID) | RDBase | Clctn_ID));
    val_mmio_write64((uint64_t)(CMDQ_BASE + g_cwriter_ptr[ItsIndex] + 3), (uint64_t)(0x0));
    g_cwriter_ptr[ItsIndex] = g_cwriter_ptr[ItsIndex] + ITS_NEXT_CMD_PTR;
}
...
{
    val_mmio_write64((uint64_t)(CMDQ_BASE + g_cwriter_ptr[ItsIndex]), (uint64_t)((DevID << ITS_CMD_SHIFT_DEVID) | ARM_ITS_CMD_MAPI));
    val_mmio_write64((uint64_t)(CMDQ_BASE + g_cwriter_ptr[ItsIndex] + 1), (uint64_t)(IntID));
    val_mmio_write64((uint64_t)(CMDQ_BASE + g_cwriter_ptr[ItsIndex] + 2), (uint64_t)(Clctn_ID));
    val_mmio_write64((uint64_t)(CMDQ_BASE + g_cwriter_ptr[ItsIndex] + 3), (uint64_t)(0x0));
    g_cwriter_ptr[ItsIndex] = g_cwriter_ptr[ItsIndex] + ITS_NEXT_CMD_PTR;
}
...
{
    val_mmio_write64((uint64_t)(CMDQ_BASE + g_cwriter_ptr[ItsIndex]), (uint64_t)((DevID << ITS_CMD_SHIFT_DEVID) | ARM_ITS_CMD_INV));
    val_mmio_write64((uint64_t)(CMDQ_BASE + g_cwriter_ptr[ItsIndex] + 1), (uint64_t)(IntID));
    val_mmio_write64((uint64_t)(CMDQ_BASE + g_cwriter_ptr[ItsIndex] + 2), (uint64_t)(0x0));
    val_mmio_write64((uint64_t)(CMDQ_BASE + g_cwriter_ptr[ItsIndex] + 3), (uint64_t)(0x0));
    g_cwriter_ptr[ItsIndex] = g_cwriter_ptr[ItsIndex] + ITS_NEXT_CMD_PTR;
}
...
{
    val_mmio_write64((uint64_t)(CMDQ_BASE + g_cwriter_ptr[ItsIndex]), (uint64_t)((DevID << ITS_CMD_SHIFT_DEVID) | ARM_ITS_CMD_DISCARD));
    val_mmio_write64((uint64_t)(CMDQ_BASE + g_cwriter_ptr[ItsIndex] + 1), (uint64_t)(IntID));
    val_mmio_write64((uint64_t)(CMDQ_BASE + g_cwriter_ptr[ItsIndex] + 2), (uint64_t)(0x0));
    val_mmio_write64((uint64_t)(CMDQ_BASE + g_cwriter_ptr[ItsIndex] + 3), (uint64_t)(0x0));
    g_cwriter_ptr[ItsIndex] = g_cwriter_ptr[ItsIndex] + ITS_NEXT_CMD_PTR;
...
{
    val_mmio_write64((uint64_t)(CMDQ_BASE + g_cwriter_ptr[ItsIndex]), (uint64_t)(ARM_ITS_CMD_SYNC));
    val_mmio_write64((uint64_t)(CMDQ_BASE + g_cwriter_ptr[ItsIndex] + 1), (uint64_t)(0x0));
    val_mmio_write64((uint64_t)(CMDQ_BASE + g_cwriter_ptr[ItsIndex] + 2), (uint64_t)(RDBase));
    val_mmio_write64((uint64_t)(CMDQ_BASE + g_cwriter_ptr[ItsIndex] + 3), (uint64_t)(0x0));
    g_cwriter_ptr[ItsIndex] = g_cwriter_ptr[ItsIndex] + ITS_NEXT_CMD_PTR;
}
  ...
  )
{
  ...
  while (creadr_value != cwriter_value) {
    ...
    if (count > WAIT_ITS_COMMAND_DONE) {
      val_print(AVS_PRINT_ERR,  "ITS : Command Queue READR not moving, Test may not pass.\n", 0);
      break;
    }
  ...
  )
{
  ...
  /* Discard Mappings */
  WriteCmdQDISCARD(ItsIndex, (uint64_t *)(ItsCommandBase), DevID, IntID);
  /* ITS SYNC Command */
  WriteCmdQSYNC(ItsIndex, (uint64_t *)(ItsCommandBase), RDBase);
  ...
  )
{
  ...
  WriteCmdQMAPD(ItsIndex, (uint64_t *)(ItsCommandBase), DevID,
                g_gic_its_info->GicIts[ItsIndex].ITTBase,
                g_gic_its_info->GicIts[ItsIndex].IDBits, 0x1 /*Valid*/);
  /* Map Collection using MAPC */
  WriteCmdQMAPC(ItsIndex, (uint64_t *)(ItsCommandBase), DevID, 0x1 /*Clctn_ID*/, RDBase, 0x1 /*Valid*/);
  /* Map Interrupt using MAPI */
  WriteCmdQMAPI(ItsIndex, (uint64_t *)(ItsCommandBase), DevID, IntID, 0x1 /*Clctn_ID*/);
  /* Invalid Entry */
  WriteCmdQINV(ItsIndex, (uint64_t *)(ItsCommandBase), DevID, IntID);
  /* ITS SYNC Command */
  WriteCmdQSYNC(ItsIndex, (uint64_t *)(ItsCommandBase), RDBase);
  ...
  )
{
  ...
  gicd_typer_idbits = ARM_GICD_TYPER_IDbits(val_mmio_read(g_gic_its_info->GicDBase + ARM_GICD_TYPER));
